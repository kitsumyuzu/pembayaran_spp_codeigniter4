									...
									<div class="card-header">
										...
										<div class="d-flex align-items-center">
                                            ...
                                            ?>
                                                ...
                                                <a href="<?= base_url('/home/insert_teacher_data/') ?>" class="ml-auto">
											...
											<table class="table table-striped table-hover table-bordered-bg-dark mt-4">
												...
												<tbody>
													...
													<?php
														...
														foreach ($teacheraccount as $_data) {

															if (in_array(session() -> get('roles'), [1, 2]) && in_array($_data -> _roles, [3])) {
														...
														<tr>
															...
															<td align="center">
																...
																<div class="form-button-action">
																	...
																	<a href="<?= base_url('/home/update_teacher_data/'.$_data -> _teacherId) ?>">
																	...
																	<a href="<?= base_url('/home/delete_teacher_data/'.$_data -> _teacherId) ?>">
																	...
																	<a href="<?= base_url('/home/view_more_teacher/'.$_data -> _teacherId) ?>">
